            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button 
                  variant="outline" 
                  size="sm"
                  className="accessibility-focus text-destructive hover:text-destructive"
                >
                  <Trash2 className="h-4 w-4 mr-1" />
                  Delete
                </Button>
              </AlertDialogTrigger>
              <AlertDialogContent className="pill-card">
                <AlertDialogHeader>
                  <AlertDialogTitle>Delete Medicine</AlertDialogTitle>
                  <AlertDialogDescription>
                    Are you sure you want to delete "{medicine.name}"? This action cannot be undone and will remove all associated schedules and intake records.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
